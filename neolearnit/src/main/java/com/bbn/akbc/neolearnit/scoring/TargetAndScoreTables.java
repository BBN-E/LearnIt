...
public class TargetAndScoreTables {
    ...
    private TargetAndScoreTables(
            ...
            @JsonProperty("params") Map<String, String> params) throws IOException {
    ...
    public TargetAndScoreTables(String targetPath) throws IOException {
        this.experimentName = LearnItConfig.get("learnit_expt_suffix");
        ...
        this.stage = "initial";
        this.params = new HashMap<String, String>(LearnItConfig.allParams());
        this.target = TargetFactory.fromJSONFile(targetPath);
    }
    ...
    public TargetAndScoreTables(TargetAndScoreTables oldTable) throws IOException {
        this(oldTable.startDate, oldTable.seedScores, oldTable.patternScores, oldTable.tripleScores, oldTable.iteration, oldTable.goodSeedPrior, oldTable.totalConfidenceDenominator, oldTable.stage, null);
    }
    ...
    public static TargetAndScoreTables deserialize(File file) throws IOException {
        ...
        in.close();
        result.target = TargetFactory.fromTargetAndScoreTablePath(file);
        return result;
    }

    public TargetAndScoreTables copyWithPatternScoreTable(final PatternScoreTable newPatternScores) throws IOException {
        return new TargetAndScoreTables(startDate, seedScores, newPatternScores, tripleScores, iteration, goodSeedPrior, totalConfidenceDenominator, stage, params);
    }

    public TargetAndScoreTables copyWithPatternAndSeedScoreTable(final PatternScoreTable newPatternScores, final SeedScoreTable newSeedScores) throws IOException {
        return new TargetAndScoreTables(startDate, newSeedScores, newPatternScores, tripleScores, iteration, goodSeedPrior, totalConfidenceDenominator, stage, params);
    }
...
//        return this.targetPath;
    ...
    public TargetAndScoreTables withNewStartDate() throws IOException {
        return new TargetAndScoreTables(new Date(), seedScores, patternScores, tripleScores, iteration, goodSeedPrior, totalConfidenceDenominator, stage, null);
    }
...
//			this.patternScores.getScore(p).setConfidenceDenominator(1.0);
    ...
    public void updateTargetAndScoreTableBasedOnMappings(Mappings mappings) {
        this.getPatternScores().updateScoreTableBasedOnMappings(mappings);
        this.getSeedScores().updateScoreTableBasedOnMappings(mappings);
