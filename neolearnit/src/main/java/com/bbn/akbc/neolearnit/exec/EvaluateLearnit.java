...
//	}
    ...
    private static EvaluationModule evaluateMonolingual(
            String apfList, String coreDir, String docList, Target target) throws IOException, ExecutionException,InterruptedException {
    ...
    private static void evaluateOldStyle(String target, String serifxmlDir, String elfDir, String apfDir, String outputFile) throws IOException,ExecutionException,InterruptedException {
