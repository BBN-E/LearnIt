...
public class NFGECEventLabeler implements MappingLabeler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Mappings labeledMappings = nfgecEventLabeler.LabelMappings(autogeneratedMappings);
        ...
        for (InstanceIdentifier instanceIdentifier : instanceIdentifierSet) {
            ...
            for (String candidateEventTypeName : candidateEventTypeNames) {
                for (String SlashJointOntologyHierachyPath : ontologyNodeNameToOntologySlashJointHierachyMap.get(candidateEventTypeName)) {
                    ...
                    if (inMemoryAnnotationStorage.isParticularAnnotationExists(instanceIdentifier, newLabelPattern))
                        continue;
                    inMemoryAnnotationStorage.addAnnotation(instanceIdentifier, newLabelPattern);
                }
            }
        }
