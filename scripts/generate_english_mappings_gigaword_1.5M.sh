...
perl sequences/generate_mappings_and_similarities.pl -sge --target=all_event_event_pairs --params=/nfs/ld100/u10/bmin/repositories/learnit.hqiu_dev/params/learnit/runs/gigaword_1.5M.params --mode=mappings-only
